    ...
    >
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1 bg-white rounded-xl border border-gray-200 p-6">
          <h2 className="text-2xl font-bold text-secondary mb-2">Technical Health Overview</h2>
          <p className="text-sm text-gray-400 mb-8">Review fleet technical status and maintenance scheduling.</p>
        ...
        <div className="w-full lg:w-64 bg-danger text-white rounded-xl p-6 shadow-lg flex flex-col justify-between">
          ...
          <div>
            <h3 className="font-bold text-xl mb-4">Urgent Maintenance</h3>
