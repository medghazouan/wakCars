...
const { list, getById, create, update, remove } = require('../controllers/technicalVisits.controller');
const { authenticate, requireRole } = require('../middleware/auth');
const validate = require('../middleware/validate');
const { createRules, updateRules, idParam } = require('../validators/technicalVisits.validators');
