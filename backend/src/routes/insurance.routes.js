...
const { list, getById, create, update, remove } = require('../controllers/insurance.controller');
const { authenticate, requireRole } = require('../middleware/auth');
const validate = require('../middleware/validate');
const { createRules, updateRules, idParam } = require('../validators/insurance.validators');
